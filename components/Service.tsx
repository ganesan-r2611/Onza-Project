  ...
  return (
    <section className="relative overflow-hidden lg:pt-[80px] 2xl:pt-[5.556vw] min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full">
        <div className="mx-auto sm:px-8 2xl:px-[2.222vw] lg:pb-10">
          <div className="flex flex-col gap-[64px] items-center">
            <div className="flex flex-col lg:flex-row items-start mt-[64px] 2xl:mt-[4.444vw] ml-4 lg:ml-0">
                <h2 className="text-[18px] md:text-[1.29vw] font-regular leading-[27px] 2xl:leading-[1.875vw] text-[#fbfbfb] mb-6 lg:mb-0 lg:ml-[80px] 2xl:ml-[5.556vw] lg:w-[165px] 2xl:w-[11.458vw]">
                {services.title}
              </h2>
              <p className="text-[28px] md:text-[3.19vw] font-light leading-tight text-[#fafafa] w-full lg:w-[66%] lg:ml-[480px] 2xl:ml-[30vw]">
                {services.subtitle}
              </p>
            </div>
