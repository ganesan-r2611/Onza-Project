...
interface BlogCardProps {
  ...
  variant?: "featured" | "standard" | "discover" | "similar";
...
const BlogCard: React.FC<BlogCardProps> = ({
  ...
  if (!post) {
    return (
      <div className="w-full flex-1 rounded-[4.44vw] lg:rounded-[1.11vw] overflow-hidden relative bg-gray-300 min-h-[443px] lg:min-h-[30.76vw] flex items-center justify-center">
        <span className="text-white">Post not available</span>
      </div>
    );
  }
  ...
  if (variant === "similar") {
    return (
      <div className="group w-full lg:w-[26.67vw] flex-1 rounded-[4.44vw] lg:rounded-[1.11vw] overflow-hidden relative bg-cover bg-center bg-no-repeat cursor-pointer">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-transform duration-700 ease-out group-hover:scale-150"
          style={{
            backgroundImage: `url(${
