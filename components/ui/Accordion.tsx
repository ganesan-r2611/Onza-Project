    ...
    <div className="flex flex-col gap-4 2xl:gap-[1.111vw]">
      {items.map((faq) => {
        ...
        return (
          <div key={faq.id}>
            <div
              className={`bg-[#0a0a0a] w-auto md:w-auto 2xl:w-auto rounded-[24px] 2xl:rounded-[1.667vw] p-8 md:p-8 lg:p-8 cursor-pointer transition-all duration-500 ease-in-out ${
                expanded ? "shadow-lg" : ""
              }`}
              style={{
            ...
            >
              ...
              >
                <div className="text-[14px] md:text-[20px] text-[#bbbbbb] font-light leading-[22px]">
                  {faq.answer}
                </div>
              </div>
            </div>
