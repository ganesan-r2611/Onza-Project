    ...
    >
      <div className="w-full h-full flex items-center">
        <div className="w-full flex items-center">
          ...
          {showIntro && (
            <div className="hidden lg:block lg:w-5/12 2xl:w-[41.67vw] flex-shrink-0 pl-4 sm:pl-6 md:pl-3 lg:pl-12 2xl:pl-[4.17vw]">
              ...
              >
                {items.map((item, i) => (
                  ...
                  >
                    ...
                    <h4 className="mt-3 2xl:mt-[1.04vw] pb-1 2xl:pb-[0.35vw] text-[20px] sm:text-[20px] md:text-[30px] lg:text-[32px] 2xl:text-[2.222vw] font-regular leading-none">
                      {item.title}
                    </h4>
                    <p className="mt-1 2xl:mt-[0.35vw] text-[18px] sm:text-[18px] md:text-[18px] lg:text-[20px] 2xl:text-[1.389vw] leading-[20px] sm:leading-[22px] 2xl:leading-[1.528vw] font-light">
                      {item.desc}
                    </p>
                  </div>
                ))}
