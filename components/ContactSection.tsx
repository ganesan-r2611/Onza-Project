...
export default function ContactSection({ data }: { data: ContactData }) {
  return (
    <section className="relative w-full" data-theme="dark">
      ...
      {/* Content Wrapper */}
      <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-32 pt-[80px] pb-[70px]">
        <div className="flex flex-col lg:flex-row justify-between items-start w-full gap-10 lg:gap-16">
          {/* Left: Title and Email */}
          <div className="w-full lg:w-[45%] flex flex-col">
            <h2 className="text-[20px] sm:text-[20px] font-regular text-[#E6E0DA] mb-6">
              {data.title}
            </h2>
            <p className="text-[38px] sm:text-[38px] font-light leading-[40px] text-[#FFDC81] w-full lg:w-[93%]">
              {data.subtitle}
            </p>
