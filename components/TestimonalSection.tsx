  ...
  return (
    <section className="bg-[#FBFBFB] text-black" data-theme="light">
      <div className="mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-start pt-[40px] md:pt-[120px] px-[16px] md:px-[140px]">
          {/* Left column - starts from left */}
          <div className="lg:col-span-5 lg:col-start-1 p-[12px]">
            <h3 className="text-[20px] font-regular mb-6 2xl:mb-[1.67vw] text-[#4A4A4A]">
              Why Choose Us?
            </h3>
            ...
            {/* Values icons */}
            <div className="flex flex-wrap gap-12 lg:gap-16 mt-10 lg:mt-20 3xl:mt-[30px]">
              {values.map((v: ValueItem) => (
                <div
                  key={v.label}
                  className="flex flex-col items-center gap-3 2xl:gap-[0.833vw]"
                >
                  ...
                  <div className="text-[20px] font-regular text-center lg:mt-1 2xl:mt-[0.278vw]">
                    {v.label}
                  </div>
                </div>
              ))}
          ...
          <div className="lg:col-span-5 lg:col-start-8 flex flex-col gap-6 2xl:gap-6 md:items-end">
            {/* Testimonial card */}
            <div className="w-full md:w-3/4 lg:w-[528px] 2xl:w-[36.667vw]">
              <div
                className="
          rounded-[16px] 2xl:rounded-[1.111vw] border border-[#0A5060] shadow-md transition-all duration-300 p-5 lg:p-8 2xl:p-[2.222vw]
          flex flex-col justify-between
          h-[300px] sm:h-[263px] md:h-[263px] 2xl:h-[18.264vw]
        "
              >
                <p
        ...
        <div className="mt-5 pt-8">
          <div className="grid grid-cols-2 sm:flex sm:flex-row justify-center items-center gap-6 lg:gap-[13vw] 2xl:gap-[14.56vw] pl-9 lg:pl-0">
            {partnerLogos.map((key: string) => (
              <div
                key={key}
                className="w-[180px] h-[100px] sm:h-[140px] flex items-center justify-center flex-shrink-0"
              >
                <Image
                  src={imageMap[key]}
                  alt={key}
