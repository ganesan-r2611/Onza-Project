...
export default function BlogDetailClient({
  ...
  const authorInfo = useInView({ threshold: 0.3 });
  const titleSection = useInView({ threshold: 0.3 });
  const introSection = useInView({ threshold: 0.3 });
  const contentSections = useInView({ threshold: 0.2 });
  const fullWidthQuote = useInView({ threshold: 0.3 });
  const additionalContent = useInView({ threshold: 0.3 });
  const sideBySide = useInView({ threshold: 0.3 });
  const finalSections = useInView({ threshold: 0.3 });
  const authorFooter = useInView({ threshold: 0.3 });
  const similarBlogs = useInView({ threshold: 0.3 });
  const newsletterSection = useInView({ threshold: 0.3 });
  ...
  return (
    <section className="relative w-full bg-[#f2e9da]">
      ...
      <div
        ...
        className={`w-full h-[136.67vw] lg:h-[62.5vw] 2xl:h-[62.5vw] overflow-hidden transition-all duration-1000 ease-out ${
          bannerSection.isInView
      ...
      <div className="w-full pt-[11.11vw] lg:pt-[2.78vw] 2xl:pt-[2.78vw] lg:pb-[8.33vw] 2xl:pb-[8.33vw]">
        ...
        <div
          ref={authorInfo.ref}
          className={`flex flex-col lg:flex-row 2xl:flex-row lg:h-[6.81vw] 2xl:h-[6.81vw] justify-between items-start lg:items-center 2xl:items-center gap-[4.44vw] lg:gap-0 2xl:gap-0 mb-[4.44vw] lg:mb-[2.78vw] 2xl:mb-[2.78vw] px-[4.44vw] lg:px-[18.82vw] 2xl:px-[18.82vw] transition-all duration-1000 ease-out ${
            authorInfo.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        ...
        <div
          ...
          className={`w-full flex flex-col gap-[4.44vw] lg:gap-[1.11vw] 2xl:gap-[1.11vw] mb-[8.33vw] lg:mb-[2.22vw] 2xl:mb-[2.22vw] px-[4.44vw] lg:px-[18.82vw] 2xl:px-[18.82vw] transition-all duration-1000 ease-out delay-200 ${
            titleSection.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        <div
          ...
          className={`mb-[11.11vw] lg:mb-[5.56vw] 2xl:mb-[5.56vw] px-[4.44vw] lg:px-[2.78vw] 2xl:px-[2.78vw] transition-all duration-1000 ease-out delay-300 ${
            introSection.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        {/* Content Sections */}
        <div
          ref={contentSections.ref}
          className={`flex flex-col gap-[11.11vw] lg:gap-[2.78vw] 2xl:gap-[2.78vw] px-[4.44vw] lg:px-[2.78vw] 2xl:px-[2.78vw] mb-[11.11vw] lg:mb-[2.78vw] 2xl:mb-[2.78vw] transition-all duration-1000 ease-out ${
            contentSections.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        <div
          ref={fullWidthQuote.ref}
          className={`my-[11.11vw] lg:my-[2.78vw] 2xl:my-[2.78vw] px-[4.44vw] lg:px-[18.82vw] 2xl:px-[18.82vw] transition-all duration-1000 ease-out ${
            fullWidthQuote.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        {/* Additional Content */}
        <div
          ref={additionalContent.ref}
          className={`lg:pt-[2.78vw] 2xl:pt-[2.78vw] px-[4.44vw] lg:px-[2.78vw] 2xl:px-[2.78vw] lg:pb-[1.39vw] 2xl:pb-[1.39vw] transition-all duration-1000 ease-out ${
            additionalContent.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        <div
          ref={sideBySide.ref}
          className={`px-[4.44vw] py-[11.11vw] lg:py-[2.78vw] 2xl:py-[2.78vw] lg:px-[18.82vw] 2xl:px-[18.82vw] transition-all duration-1000 ease-out ${
            sideBySide.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        ...
        <div
          ref={finalSections.ref}
          className={`px-[4.44vw] lg:px-[2.78vw] 2xl:px-[2.78vw] pb-[11.11vw] lg:pb-[2.78vw] 2xl:pb-[2.78vw] transition-all duration-1000 ease-out ${
            finalSections.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
        ...
        {/* Author Footer */}
        <div
          ref={authorFooter.ref}
          className={`flex flex-col lg:flex-row 2xl:flex-row lg:h-[6.81vw] 2xl:h-[6.81vw] justify-between items-start lg:items-center 2xl:items-center gap-[4.44vw] lg:gap-0 2xl:gap-0 mb-[4.44vw] lg:mb-[2.78vw] 2xl:mb-[2.78vw] px-[4.44vw] lg:px-[18.82vw] 2xl:px-[18.82vw] transition-all duration-1000 ease-out ${
            authorFooter.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
      ...
      {/* Similar Blogs */}
      <section
        ref={similarBlogs.ref}
        className={`hidden lg:block 2xl:block w-full bg-[#121819] px-[16px] lg:px-[8.33vw] 2xl:px-[8.33vw] py-[80px] lg:py-[5.56vw] 2xl:py-[5.56vw] transition-all duration-1000 ease-out ${
          similarBlogs.isInView
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-8"
        }`}
      >
      ...
      <section className="relative w-full h-full py-20 md:py-16 lg:py-20 2xl:py-[6.94vw]">
        ...
        <div
          ...
          className={`relative z-10 w-full mx-auto px-6 sm:px-8 lg:px-[120px] 2xl:px-[8.33vw] flex flex-col lg:flex-row 2xl:flex-row items-center gap-16 lg:gap-24 2xl:gap-[8.33vw] transition-all duration-1000 ease-out ${
            newsletterSection.isInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
